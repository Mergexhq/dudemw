...
export default function RefundPolicyEditor({ cmsPage }: RefundPolicyEditorProps) {
    ...
    const handleSave = async () => {
        ...
        setIsSaving(true)
        try {
            await updateCMSPage('refund-policy', {
                content,
    ...
    return (
        <div className="max-w-5xl mx-auto p-6">
            <div className="mb-6">
                ...
                <p className="text-gray-600">Manage the content displayed on the Refund Policy page</p>
            </div>

            <div className="bg-white border rounded-lg p-6 space-y-6">
                <div>
                    <Label htmlFor="refund-content" className="text-base font-semibold mb-3 block">
                        Policy Content
                    </Label>
                    <p className="text-sm text-gray-500 mb-3">
                        Write and format your Refund Policy using the rich text editor below.
                    </p>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-gray-500">Make this content visible on the Refund Policy page</p>
                    </div>
                    <Switch
                        id="is-published"
                        checked={isPublished}
