...
interface AboutCMSEditorProps {
    cmsPage: CMSPage | null
}

export default function AboutCMSEditor({ cmsPage }: AboutCMSEditorProps) {
    ...
    return (
        <div className="max-w-5xl mx-auto p-6">
            <div className="mb-6">
                <h1 className="text-2xl font-bold mb-2">About Us Content</h1>
                <p className="text-gray-600">Manage the content displayed on the About Us page</p>
            </div>

            <div className="bg-white border rounded-lg p-6 space-y-6">
                <div>
                    <Label htmlFor="about-content" className="text-base font-semibold mb-3 block">
                        About Us Story
                    </Label>
                    <p className="text-sm text-gray-500 mb-3">
                        Write and format your About Us content using the rich text editor below.
                    </p>
                    <div className="border rounded-lg overflow-hidden">
                        <ReactQuill
                            ...
                            placeholder="Write your About Us story here..."
                        />
                    </div>
                </div>
